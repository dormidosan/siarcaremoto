...
!function () {
    ...
    var LobiboxBase = {
        $type: null, $el: null, $options: null, debug: function () {
            ...
            var header = $('<div class="lobibox-header"></div>').append('<span class="lobibox-title"></span>'), body = $('<div class="lobibox-body"></div>');
            ...
            var me = this, headerHeight = me.$el.find(".lobibox-header").outerHeight(), footerHeight = me.$el.find(".lobibox-footer").outerHeight();
            ...
            heading.on("mousedown.lobibox", function (ev) {
                ...
                if ("true" === el.attr("allow-drag")) {
                    var left = ev.clientX - parseInt(el.attr("offset-left"), 10) - parseInt(el.css("border-left-width"), 10), top = ev.clientY - parseInt(el.attr("offset-top"), 10) - parseInt(el.css("border-top-width"), 10);
            ...
            var me = this;
            return me._triggerEvent("beforeClose"), me.$options.hideClass ? (me.$el.removeClass(me.$options.showClass).addClass(me.$options.hideClass), setTimeout(function () {
                callback()
            }, me.$options.delayToRemove)) : callback(), this
            ...
            if (me._triggerEvent("onShow"), me.$el.removeClass("lobibox-hidden"), $body.append(me.$el), me.$options.buttons) {
                var buttons = me.$el.find(".lobibox-footer").children();
                buttons[0].focus()
            }
            return me.$options.modal && ($body.addClass(Lobibox.base.OPTIONS.bodyClass), me._addBackdrop()), me._triggerEvent("shown"), me
        }
    };
    Lobibox.base = {}, Lobibox.base.OPTIONS = {
        ...
        _init: function () {
            var me = this;
            LobiboxBase._init.call(me), me.show(), me._setContent(me._createInput())._position(), me.$input.focus()
        },
        ...
        _createProgressbar: function () {
            var me = this, outer = $('<div class="lobibox-progress-bar-wrapper lobibox-progress-outer"></div>').append('<div class="lobibox-progress-bar lobibox-progress-element"></div>');
...
!function () {
    var LobiboxNotify = function (type, options) {
        ...
        var me = this, _processInput = function (options) {
            return ("mini" === options.size || "large" === options.size) && (options.width = options.width || Lobibox.notify.OPTIONS[options.size].width), options = $.extend({}, Lobibox.notify.OPTIONS[me.$type], Lobibox.notify.DEFAULTS, options), "mini" !== options.size && options.title === !0 ? options.title = Lobibox.notify.OPTIONS[me.$type].title : "mini" === options.size && options.title === !0 && (options.title = !1), options.icon === !0 && (options.icon = Lobibox.notify.OPTIONS.icons[options.iconSource][me.$type]), options.sound === !0 && (options.sound = Lobibox.notify.OPTIONS[me.$type].sound), options.sound && (options.sound = options.soundPath + options.sound + options.soundExt), options
        }, _init = function () {
        ...
        this.remove = function () {
            ...
            var parent = me.$el.parent(), wrapper = parent.closest(".lobibox-notify-wrapper-large"), href = "#" + parent.attr("id"), $li = wrapper.find('>.lb-notify-tabs>li:has(a[href="' + href + '"])');
