...
Route::group(['prefix' => 'asambleistas'], function () {
    Route::get('listado_asambleistas_facultad', "AsambleistaController@listado_asambleistas_facultad")->name("listado_asambleistas_facultad");
    Route::get('listado_asambleistas_comision', "AsambleistaController@listado_asambleistas_comision")->name("listado_asambleistas_comision");
    Route::get('listado_asambleistas_junta', "AsambleistaController@listado_asambleistas_junta")->name("listado_asambleistas_junta");
});
