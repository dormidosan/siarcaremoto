...
@section('breadcrumb')
    <section class="">
        <ol class="breadcrumb">
            ...
            <li><a class="active">Permisos Temporales</a></li>
        </ol>
    </section>
@endsection
                ...
                @if(!($resultados==NULL))
                    ...
                    @foreach($resultados as $result)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url("/Reporte_permisos_temporales/1.$result->id.$result->periodo_id.$result->fecha")}}"
                                   class="btn btn-block btn-success btn-xs">VER</a></td>
                            <td>
                                <a href="{{url("/Reporte_permisos_temporales/2.$result->id.$result->periodo_id.$result->fecha")}}"
