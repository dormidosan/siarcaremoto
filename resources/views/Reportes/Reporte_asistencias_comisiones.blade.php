...
@section('breadcrumb')
    <section class="">
        <ol class="breadcrumb">
            ...
            <li><a class="active">Asistencias Comisiones</a></li>
        </ol>
    </section>
@endsection
...
@section('content')
    <div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title">Reporte asistencias de comisiones</h3>
        </div>
        <div class="box-body">
            <form id="buscarDocs" method="post" action="{{ url("buscar_asistencias_comisiones") }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-3 col-sm-12 col-md-3">
                        <label>Comision</label>
                        {!! Form::select('periodo',$periodos,$periodo,['id'=>'periodo','name'=>'periodo','class'=>'form-control','requiered'=>'required','placeholder'=>'seleccione comision']) !!}
                    </div>
                ...
                @if(!($resultados==NULL))
                    @foreach($resultados as $result)
                        <tr>
                            ...
                            <td>
                                <a href="{{url("/Reporte_asistencias_comisiones/1.$result->id")}}"
                                   class="btn btn-block btn-success btn-xs">VER</a></td>
                            <td>
                                <a href="{{url("/Reporte_asistencias_comisiones/2.$result->id")}}"
