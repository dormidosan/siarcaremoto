...
@section('content')
    <div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title">Plantilla de Dictamenes</h3>
        </div>
        <div class="box-body">
            <form id="buscarDocs" method="post" action="{{ url("buscar_dictamenes") }}">
                  {{ csrf_field() }}
                <div class="row">
        ...
        <div class="box-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a href="{{url("/desc_Plantilla_dictamenes/$result->id.$result->periodo_id.$result->codigo.$result->fecha.$result->lugar")}}" class="btn btn-block btn-success btn-xs">DESCARGAR</a>
                    </td>
                </tr>
                @endforeach
                @endif
